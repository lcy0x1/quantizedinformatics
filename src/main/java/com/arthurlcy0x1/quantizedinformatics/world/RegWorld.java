...
public class RegWorld {
	...
	public static final Biome QIB_SS0 = getQIBiome("solid_small_lo", 0.1, 0, 0, 0);
	public static final Biome QIB_SS1 = getQIBiome("solid_small_mi", 0.2, 0, 0, 0);
	public static final Biome QIB_SS2 = getQIBiome("solid_small_hi", 0.4, 0, 0, 0);
	public static final Biome QIB_SM0 = getQIBiome("solid_mid_lo", 0.015, 0, 7, 0);
	public static final Biome QIB_SM1 = getQIBiome("solid_mid_mi", 0.030, 0, 7, 0);
	public static final Biome QIB_SM2 = getQIBiome("solid_mid_hi", 0.060, 0, 7, 0);
	public static final Biome QIB_SL0 = getQIBiome("solid_large_lo", 0.003, 0, 12, 0);
	public static final Biome QIB_SL1 = getQIBiome("solid_large_mi", 0.006, 0, 12, 0);
	public static final Biome QIB_SL2 = getQIBiome("solid_large_hi", 0.012, 0, 12, 0);
	public static final Biome QIB_LM0 = getQIBiome("loose_mid_lo", 0.021, 5, 7, 1);
	public static final Biome QIB_LM1 = getQIBiome("loose_mid_mi", 0.042, 5, 7, 1);
	public static final Biome QIB_LM2 = getQIBiome("loose_mid_hi", 0.063, 5, 7, 1);
	public static final Biome QIB_LL0 = getQIBiome("loose_large_lo", 0.005, 5, 12, 1);
	public static final Biome QIB_LL1 = getQIBiome("loose_large_mi", 0.010, 5, 12, 1);
	public static final Biome QIB_LL2 = getQIBiome("loose_large_hi", 0.020, 5, 12, 1);
