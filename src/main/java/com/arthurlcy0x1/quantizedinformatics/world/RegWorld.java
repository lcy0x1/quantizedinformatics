...
public class RegWorld {
	...
	public static final Biome QIB_SM0 = getQIBiome("solid_mid_lo", 1.10, 1, 5, 0);
	public static final Biome QIB_SM1 = getQIBiome("solid_mid_mi", 1.15, 1, 5, 0);
	public static final Biome QIB_SM2 = getQIBiome("solid_mid_hi", 1.25, 1, 5, 0);
	public static final Biome QIB_SL0 = getQIBiome("solid_large_lo", 0.05, 5, 12, 1);
	public static final Biome QIB_SL1 = getQIBiome("solid_large_mi", 0.10, 5, 12, 1);
	public static final Biome QIB_SL2 = getQIBiome("solid_large_hi", 0.20, 5, 12, 1);
	public static final Biome QIB_LM0 = getQIBiome("loose_mid_lo", 1.10, 5, 7, 1);
	public static final Biome QIB_LM1 = getQIBiome("loose_mid_mi", 1.15, 5, 7, 1);
	public static final Biome QIB_LM2 = getQIBiome("loose_mid_hi", 1.30, 5, 7, 1);
	public static final Biome QIB_LL0 = getQIBiome("loose_large_lo", 0.05, 7, 12, 2);
	public static final Biome QIB_LL1 = getQIBiome("loose_large_mi", 0.10, 7, 12, 2);
	public static final Biome QIB_LL2 = getQIBiome("loose_large_hi", 0.20, 7, 12, 2);
